 ...
 * @author Shaikh
 */
public class ResultUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("STUDENTS ID DATABASE");
        ...
        jLabel2.setText("ENTER STUDENT ID TO UPDATE RESULT:");
        ...
        setSize(new java.awt.Dimension(1068, 655));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultUpdateExtended obj = new ResultUpdateExtended();
        obj.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResultUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultUpdate().setVisible(true);
            }
        });
    }
