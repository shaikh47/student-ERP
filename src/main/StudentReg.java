...
public class StudentReg extends javax.swing.JFrame {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(passConf, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       String str_pass_conf = passConf.getText();
       ...
       String sql="Insert into student_info (id,name,pass,dob,gender,email,phone,fname,mname,fnum,mnum,lname,lnum ) value (?,?,?,?,?,?,?,?,?,?,?,?,?)";
       String sql1="Insert into student_result (studentid) value (?)";
       String sql2 = "Insert into accounts (studentid,total_gpa,waiver,money_given,due,tobe_paid,waiver_money) value (?,?,?,?,?,?,?)";
       try
       {
         
            String combo_value = gender.getSelectedItem().toString();
            ...
            pst.setString(5,combo_value);
            pst.setString(6,email.getText());
            pst.setString(7,phone.getText());
            pst.setString(8,fname.getText());
            pst.setString(9,mname.getText());
            pst.setString(10,fnum.getText());
            pst.setString(11,mnum.getText());
            pst.setString(12,lname.getText());
            pst.setString(13,lnum.getText());
