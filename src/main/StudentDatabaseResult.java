 ...
 * @author Shaikh
 */
public class StudentDatabaseResult extends javax.swing.JFrame {

      Connection conn =null;
      PreparedStatement pst=null;
      ResultSet rs= null;
      
    public StudentDatabaseResult() {
        initComponents();
      ...
      public void fetch(){
        try{
            ...
            String q = "select studentid,bangla(grade),english(grade),gk(grade),ict(grade),math(grade),science(grade),socialscience(grade) from student_result";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "1", "Title 2", "Title 3", "null", "Title 5", "Title 6", "Title 7", "Title 8"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentDatabaseResult.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentDatabaseResult().setVisible(true);
            }
        });
    }
